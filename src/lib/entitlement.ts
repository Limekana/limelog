...
// and same storage shape as StudyDesk's `src/lib/entitlement.js`; kept as a
// per-app copy rather than a shared package because the three apps have no
// shared build and each ships to F-Droid independently.
//
...
const CACHE_KEY = 'wt_entitlement';
